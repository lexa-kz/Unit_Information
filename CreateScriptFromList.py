...
# TELNET - - - - - - - - - - - - - - - - - - - -
def telnet_ucs_audit(host, ird_name_liat):
    """
    ...
    for name_of_ird in ird_name_list:
        ...
        telnet.write(b'2\r\n')
        print('=>{} 97. time.sleep(40)'.format(host))
        time.sleep(40)
