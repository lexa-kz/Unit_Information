...
print('создаётся таблица KATEL2 , если её нет')
cursor.execute("CREATE TABLE if not exists KATEL2 (ua text not null primary key, name text, tiers text, misc1 text, misc2 text, misc3 text, misc4 text, misc5 text, misc6 text);")
connection.commit()
...
def sql_queries(db_table, somedata):
    ...
    query = "REPLACE into KATEL2 (ua, tiers, name, misc1, misc2, misc3, misc4, misc5, misc6) values ('{}','{}','{}','{}','{}','{}','{}','{}','{}');".format(
